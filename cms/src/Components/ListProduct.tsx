...
const ListProduct: FC<Props> = ({ product, bg }) => {
    return (
        <div className="w-full relative group flex flex-col md:flex-row items-center border-[1px] hover:shadow-lg duration-200 shadow-gray-500 rounded-md overflow-hidden group">
            <div className="max-w-80 max-h-80 flex">
                ...
                >
                    ...
                    >
                        <Image
                            className="w-72 h-72 object-contain pl-3"
